...
User.prototype.getBucketForCard = function(contract_number, callback) {

  var bucket = this.products.filter(function(product) {
    return product.type === "account" && product.alias === "bucket:" + contract_number
  })
...
User.prototype.addDefaultProducts = function() {
  ...
  this.addProduct(new Product({
    "type": "account",
    "contract_number": "00260329340113075657",
    "balance": 0,
    "available_balance": 0,
    "currency": "EUR",
    "alias": "bucket:4057849369252814",
    "transactions": [
...
User.prototype.getDefaultTransactions = function() {
  return [
    ...
    new Transaction({
      ...
      description: "Αγορά Ergonomic heuristic flexibility",
      amount: -58,
      new_balance: -457.26,
      mcc: "3040"
    }),
